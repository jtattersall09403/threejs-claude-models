...
export function buildJawSpikes(field) {
  ...
  for (const s of [1, -1]) {
    ...
    for (const [p, dir, len, r] of [
      [[s * 0.0300, 1.5990, 0.094], [s * 0.11, -0.32, -0.94], 0.0160, 0.0150],
      [[s * 0.0400, 1.6005, 0.056], [s * 0.13, -0.26, -0.96], 0.0205, 0.0195],
      [[s * 0.0505, 1.6110, 0.016], [s * 0.16, -0.16, -0.97], 0.0350, 0.0270],
      [[s * 0.0565, 1.6410, -0.002], [s * 0.19, 0.04, -0.98], 0.0390, 0.0290],
    ]) {
